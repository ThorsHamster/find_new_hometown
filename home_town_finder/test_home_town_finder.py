...
def test_home_town_finder_initialize_data_not_existing_api_key(mocker):
    mocker.patch('home_town_finder.home_town_finder.YmlReader.read', side_effect=[{'cities': 'a'},
                                                                                  {'target_city_1': 'city_A',
                                                                                   'target_city_2': 'city_B',
                                                                                   'option': 'duration'}])
...
def test_home_town_finder_initialize_data_not_existing_target_city_1(mocker):
    mocker.patch('home_town_finder.home_town_finder.YmlReader.read', side_effect=[{'cities': 'a'},
                                                                                  {'api_key': 10,
                                                                                   'target_city_2': 'city_B',
                                                                                   'option': 'duration'}])
...
def test_home_town_finder_initialize_data_not_existing_target_city_2(mocker):
    mocker.patch('home_town_finder.home_town_finder.YmlReader.read', side_effect=[{'cities': 'a'},
                                                                                  {'api_key': 10,
                                                                                   'target_city_1': 'city_A',
                                                                                   'option': 'duration'}])
...
def test_home_town_finder_initialize_data_not_existing_option(mocker):
    mocker.patch('home_town_finder.home_town_finder.YmlReader.read', side_effect=[{'cities': 'a'},
                                                                                  {'api_key': 10,
                                                                                   'target_city_1': 'city_A',
                                                                                   'target_city_2': 'city_B'}])
...
def test_home_town_finder_initialize_option_value_not_valid(mocker):
    mocker.patch('home_town_finder.home_town_finder.YmlReader.read', side_effect=[{'cities': 'a'},
                                                                                  {'api_key': 10,
                                                                                   'target_city_1': 'city_A',
                                                                                   'target_city_2': 'city_B',
